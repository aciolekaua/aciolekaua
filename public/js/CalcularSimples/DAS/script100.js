...
afterDatasetDraw(chart, args, options) {
    ...
    ctx.fillStyle = '#6c757d';
    ctx.fillText('RBT12: ' +'R$ ' + calculo, cx, cy + 30);
    ...
    $.ajax({
        ...
        success: function(data,status,xhr){
            ...
            for(let i=1;i<=5;i++){
                ...
                document.querySelector('h2[id=div_valor_faturamento_sem_rentencao_anexo_'+i+']').innerText = "Anexo "+i+":"+faturamento_sem_retencao.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
                document.querySelector('h2[id=div_valor_faturamento_com_rentencao_anexo_'+i+']').innerText = "Anexo "+i+":"+faturamento_com_retencao.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
