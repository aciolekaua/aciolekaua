...
function start_tippys(){
    ...
    tippy('#rbt12', {
        content: '<h4 style="color:#d1cccc">RBA:  <span style="color: #fff;"> R$ 240,00</span></h4><h4 style="color:#d1cccc;">RBAA: <span style="color: #fff;">R$ 1.3467,00</span></h4 style="color:#d1cccc"><h4 style="color:#d1cccc">RBT12: <span style="color: #2fb490;">R$ 425.365,00</span></h4>',
        allowHTML: true,
        duration:50,
        maxWidth: 400,
        placement: 'top',
