...
function escreverListaArquivos(data){
    ...
    for(let i=0;i<=data.length-1;i++){
        ...
        if(data[i].extensao=="pdf"){
            item.innerText= "<i class='bi bi-file-pdf h4 text-danger me-2'></i>"+data[i].nome;
        }else if(
            data[i].extensao=="png"
            || data[i].extensao=="jpeg"
            || data[i].extensao=="jpg"
        ){
            item.innerText= "<i class='bi bi-file-image h4 text-primary me-2'></i>"+data[i].nome;
        }else{
            item.innerText= "<i class='bi bi-question-square h4 text-secondary me-2'></i>"+data[i].nome;
        }
