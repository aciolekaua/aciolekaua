...
function dselect(el, option = {}) {
  ...
  const searchInput = search ? `<input onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control" placeholder="Pesquise" autofocus>` : ''
  ...
  function isPlaceholder(option) {
    return option.getAttribute('value') === "Pesquise"
  }
