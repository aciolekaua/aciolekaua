      ...
      $.ajax({
          ...
          success: function(data,status,xhr){
              ...
              if(data.TipoCliente=="PF"){
                ...
                cardPagamento.innerHTML=""+data.saldo.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
                
                cardRecebimento.innerHTML=""+data.saldo.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
