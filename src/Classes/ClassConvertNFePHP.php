 ...
 * Manual de Importa��o/Exporta��o TXT Notas Fiscais eletr�nicas vers�o 2.0.0
 *
 * @package     NFePHP
 * @name        ConvertNFePHP
 * @version     3.0.1
...
class ClassConvertNFePHP {
    ...
    /**
     * nfetxt2xml
     * M�todo de convers�o das NFe de txt para xml, conforme
     * especifica��es do Manual de Importa��o/Exporta��o TXT
     * Notas Fiscais eletr�nicas vers�o 2.0.0 (24/08/2010)
     * Referente ao modelo de NFe contido na vers�o 4.0.1-NT2009.006
     * de Dezembro de 2009 do manual de integra��o da NFe, incluindo a 
     * Nota T�cnica 2011/002 de mar�o de 2011
     *
     * @package NFePHP
     * @name nfetxt2xml
     * @version 3.0.0
    ...
    /**
     *__calculaDV
     * Fun��o para o calculo o digito verificador da chave da NFe
	...
	$notas=array();
        ...
        for($l = 0; $l < count($arquivo); $l++) {
            ...
            //remove todos os espa�os adicionais, tabs, linefeed, e CR
            ...
            switch ( $dados[0] ) {
                case "NOTA FISCAL": // primeiro elemento n�o faz nada, aqui � informado o n�mero de NF contidas no TXT
                    break;

                case "A":  //atributos da NFe, campos obrigat�rios [NFe]
                    //A|vers�o do schema|id
			// cria nota no array
		    $cur_nota++;
		    unset($dom,$NFe,$infNFe,$NFref,$refNFP);
		    /// limpar todas variaveis utilizadas por cada nota fiscal.... (evitar que o produto entre 2 vezes ou q o endere�o anterior seja usado, e coisas do tipo....)
			...
			$notas[$cur_nota]['NFref']=$dom->createElement("NFref");
                ...
                case "B20a": //Grupo de informa��es da NF [NFref]
                    if(!isset($NFref)){
			$notas[$cur_nota]['NFref']=$dom->createElement("NFref");
                       $NFref = & $notas[$cur_nota]['NFref'];
                       $ide->insertBefore($ide->appendChild($NFref),$tpImp);
			...
			$NFref = & $notas[$cur_nota]['NFref'];
                ...
                case "C05"://Grupo do Endere�o do emitente [emit]
		    ...
		    $dados[2]=abs((int)$dados[2]);
                ...
                case "E": //Grupo de identifica��o do Destinat�rio da NF-e [infNFe]
                    //E|xNome|IE|ISUF|email|
                    $dest = $dom->createElement("dest");
                    //se ambiente homologa��o preencher conforme NT2011.002
                    //v�lida a partir de 01/05/2011
                    if ($this->tpAmb == '2'){
                ...
                case "E02": //CNPJ [dest]
                    ...
                    if ($this->tpAmb == '2'){
                        if ($dados[1] != ''){
                            //opera��o nacional em ambiente homologa��o usar 99999999000191
                            $CNPJ = $dom->createElement("CNPJ", '99999999000191');
                        } else {
                            //opera��o com o exterior CNPJ vazio
                ...
                case "E05": //Grupo de endere�o do Destinat�rio da NF-e [dest]
                ...
                case "F": //Grupo de identifica��o do Local de retirada [infNFe]
                ...
                case "G": // Grupo de identifica��o do Local de entrega [entrega]
                ...
                case "H": // Grupo do detalhamento de Produtos e Servi�os da NF-e [infNFe]
                ...
                case "I18": //Tag da Declara��o de Importa��o [prod]
                ...
                case "J": //Grupo do detalhamento de ve�culos novos [prod]
                ...
                case "K": //Grupo do detalhamento de Medicamentos e de mat�riasprimas farmac�uticas [prod]
                ...
                case "L101": //Grupo de informa��es espec�ficas para combust�veis l�quidos e lubrificantes [prod]
                    ...
                    case "N06": //Grupo de Tributa��o do ICMS 40, 41 ou 50 [ICMS]
                    ...
                    case "N07": //Grupo de Tributa��o do ICMS = 51 [ICMS]
                    ...
                    case "N08": //Grupo de Tributa��o do ICMS = 60 [ICMS]
                    ...
                    case "N09": //Grupo de Tributa��o do ICMS 70 [ICMS]
                    ...
                    case "N10": //Grupo de Tributa��o do ICMS 90 Outros [ICMS]
                    ...
                    case "N10a": //Partilha do ICMS entre a UF de origem e UF de destino ou a UF definida na legisla��o [ICMS]
                    ...
                    case "N10b": //ICMS ST � repasse de ICMS ST retido anteriormente em opera��es interestaduais com repasses atrav�s do Substituto Tribut�rio [ICMS]
                    ...
                    case "O08": //Grupo IPI N�o tributavel 0 ou 1 [IPI]
                        // todos esses campos sao obrigatorios
                    ...
                    case "P": //Grupo do Imposto de Importa��o 0 ou 1 [imposto]
                        // todos esses campos sao obrigatorios
                    ...
                    case "Q02": //Grupo de PIS tributado pela al�quota 0 pou 1 [PIS]
                        // todos esses campos sao obrigatorios
                    ...
                    case "Q04": //Grupo de PIS n�o tributado 0 ou 1 [PIS]
                        // todos esses campos sao obrigatorios
                    ...
                    case "Q05": //Grupo de PIS Outras Opera��es 0 ou 1 [PIS]
                        //Q05|CST|vPIS|
                    ...
                    case "Q07": //Valor da Base de C�lculo do PIS e Al�quota do PIS (em percentual) 0 pu 1 [PISOutr]
                        // todos esses campos sao obrigatorios
                        //Q07|vBC|pPIS|
                        $vBC = $dom->createElement("vBC", $dados[1]);
                    ...
                    case "Q10": //Quantidade Vendida e Al�quota do PIS (em reais) 0 ou 1 [PISOutr]
                        // todos esses campos sao obrigatorios
                    ...
                    case "R": //Grupo de PIS Substitui��o Tribut�ria 0 ou 1 [imposto]
                        // todos esses campos sao obrigatorios
                    ...
                    case "R02": //Valor da Base de C�lculo do PIS e Al�quota do PIS (em percentual) 0 ou 1 [PISST]
                        // todos esses campos sao obrigatorios
                        $vBC = $dom->createElement("vBC", $dados[1]);
                    ...
                    case "R04": //Quantidade Vendida e Al�quota do PIS (em reais) 0 ou 1 [PISST]
                        // todos esses campos sao obrigatorios
                        $qBCProd = $dom->createElement("qBCProd", $dados[1]);
                    ...
                    case "S": //Grupo do COFINS obrigat�rio [imposto]
                        $COFINS = $dom->createElement("COFINS");
                        $imposto->appendChild($COFINS);
                        break;

                    case "S02": //Grupo de COFINS tributado pela al�quota 0 ou 1 [COFINS]
                        // todos esses campos sao obrigatorios
                    ...
                    case "S04": //Grupo de COFINS n�o tributado 0 ou 1 [COFINS]
                        // todos esses campos sao obrigatorios
                    ...
                    case "S05"://Grupo de COFINS Outras Opera��es 0 ou 1 [COFINS]
                        //S05|CST|vCOFINS|
                    ...
                    case "S07": //Valor da Base de C�lculo da COFINS e Al�quota da COFINS (em percentual) 0 ou 1 [COFINSOutr]
                        // todos esses campos sao obrigatorios
                        $vBC = $dom->createElement("vBC", $dados[1]);
                    ...
                    case "S09": //Quantidade Vendida e Al�quota da COFINS (em reais) 0 ou 1 [COFINSOutr]
                        // todos esses campos sao obrigatorios
                        $qBCProd = $dom->createElement("qBCProd", $dados[1]);
                    ...
                    case "T": //Grupo de COFINS Substitui��o Tribut�ria 0 ou 1 [imposto]
                        // todos esses campos sao obrigatorios
                    ...
                    case "T02": //Valor da Base de C�lculo da COFINS e Al�quota da COFINS (em percentual) 0 ou 1 [COFINSST]
                        // todos esses campos sao obrigatorios
                        $vBC = $dom->createElement("vBC", $dados[1]);
                    ...
                    case "T04": //Quantidade Vendida e Al�quota da COFINS (em reais) 0 u 1 [COFINSST]
                        // todos esses campos sao obrigatorios
                        $qBCProd = $dom->createElement("qBCProd", $dados[1]);
                    ...
                    case "W23": //Grupo de Reten��es de Tributos 0 ou 1 [total]
                    ...
                    case "X": // Grupo de Informa��es do Transporte da NF-e obrigatorio [infNFe]
                    ...
                    case "X11": //Grupo de Reten��o do ICMS do transporte 0 ou 1 [transp]
                        // todos esses campos s�o obrigat�rios
                    ...
                    case "X18": //Grupo Ve�culo 0 ou 1 [transp]
                        if (!empty($dados[1])){
                    ...
                    case "Y": //Grupo de Cobran�a 0 ou 1 [infNFe]
                    ...
                    case "Z": //Grupo de Informa��es Adicionais 0 ou 1 [infNFe]
                    ...
                    case "ZA": //Grupo de Exporta��o 0 ou 1 [infNFe]
                        //todos os campos s�o obrigatorios
                    ...
                    case "ZC04": //1 a 31 Grupo de Fornecimento di�rio de cana [cana]
                        //ZC04|dia|qtde|
                        //todos os campos s�o obrigatorios
                    ...
                    case "ZC10": //0 a 10 Grupo de Dedu��es � Taxas e Contribui��es [cana]
                        //ZC10|xDed|vDed|
                        //todos os campos s�o obrigatorios
	...
	foreach($notas as $nota){
		...
		if(!empty($infNFe)){
		    ...
		    //remove linefeed, carriage return, tabs e multiplos espa�os
...
var_dump($dom);
	    $CONTADOR_NOTAS++;
            ...
            //instaciar uma vari�vel para contagem
            $i = 0;
            foreach ($det as $d){
                //H|nItem|infAdProd|
		...
		$IPI  = $imposto->getElementsByTagName("IPI")->item(0);
                ...
                switch ($CST) {
                    ...
                    case '60': //CST 60 ICMS COBRADO ANTERIORMENTE POR ST
                        ...
                        break;
                    case '70': //CST 70 - Com redu��o de base de c�lculo e cobran�a do ICMS por substitui��o tribut�ria
                ...
                if ( isset($IPI) ){
                    ...
                    //grupo de tributa��o de IPI NAO TRIBUTADO
    		...
    		//monta dados do PIS
                ...
                //monta dados do PIS em Substitui��o Tribut�ria
                if ( isset($PISST) ) {
                ...
                //monta dados do COFINS em Substitui��o Tribut�ria
                if ( isset($COFINSST) ) {
        ...
        //monta dados da Reten��o de tributos
        if ( isset($retTrib) ) {
        ...
        if ( isset($transp) ) {
            ...
            if ( isset($transporta) ){
                ...
                //monta dados da reten��o tribut�ria de transporte
                if ( isset($retTransp) ) {
                ...
                //monta dados de identifica��o dos veiculos utilizados no transporte
                if ( isset($veicTransp) ) {
                    //X18|Placa|UF|RNTC|
                ...
                //monta dados de identifica��o dos reboques utilizados no transporte
                if ( isset($reboque) ){
            ...
            //monta dados das informa��es adicionais da NFe
            if ( isset($infAdic) ) {
                ...
                //monta dados de observa�oes da NFe
                if ( isset($obsCont) ){
	...
	$txt = utf8_decode("NOTA FISCAL|$CONTADOR_NOTAS\r\n".$txt);
        
        $this->txt = $txt;
        return $txt;
    }// fim da fun��o nfexml2txt
