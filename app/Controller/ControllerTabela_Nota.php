...
class ControllerTabela_Nota{
    ...
    public function __construct(){
        ...
        $this->Render->setDir("Tabelas/Nota");
        $this->Render->setTitle("Nota");
        $this->Render->setDescription("Pagina de lanﾃｧamentos MVC");
    ...
    public function executar(){
        ...
        if(isset($_POST['excluir'])){
            ...
            $resul=$this->Validate->validateDeleteNota($sel['sel']);
            ...
            if(count($this->Validate->getError())>0){
                ...
                if($resul['apagados']>0){
                    ...
                    $this->Write->Mensage("{$resul['nApagados']} linha(s) Nﾃグ apagada(s)","mensage","alert alert-danger");
                }else if($resul==false){
