...
$Validate=new ClassValidate;
 ...
 if($_SESSION['TipoCliente']=="PF"){
    if(isset($_POST['pj']) && !empty($_POST['pj'])){
        ...
        $dados=$Validate->validateGetRecebimento($_SESSION['ID'],$_SESSION['TipoCliente'],$_SESSION['TipoPermissao'],$Cnpj);
        ...
        if(!$dados){
            ...
            for($l=0;$l<=$lNum-1;$l++){
                ...
                if($exclusao || $conselho){
                    ...
                    $cnpj=$GestaoDeConselho->getCNPJ_IdTabela($dados[$l]['ID'],"Recebimento");
                    $CNPJ=$cnpj['dados']['str_empresa_Recebimento'];
    ...
    $dados=$Validate->validateGetRecebimento($_SESSION['ID'],$_SESSION['TipoCliente']);
    //var_dump($dados);
